 ...
 * @Version 1.0
 */
public class CorrectedTriangle {
    // 三角形类型枚举类型
    ...
    // 三边长度
    public double sideA = 1, sideB = 1, sideC = 1;

    // 三角形类型
    public TriangleType Type = TriangleType.Equilateral;

    // 构造函数
    public CorrectedTriangle(double a, double b, double c) {
        this.sideA = a;
        this.sideB = b;
        this.sideC = c;
