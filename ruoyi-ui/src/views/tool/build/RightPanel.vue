      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          <el-form-item v-if="activeData.vModel !== undefined" label="字段名">
            <el-input
              v-model:value="activeData.vModel"
          ...
          <el-form-item v-if="activeData.label !== undefined" label="标题">
            <el-input
              v-model:value="activeData.label"
              placeholder="请输入标题"
            />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item v-if="activeData.prepend !== undefined" label="前缀">
            <el-input
              v-model:value="activeData.prepend"
              placeholder="请输入前缀"
            />
          </el-form-item>
          <el-form-item v-if="activeData.append !== undefined" label="后缀">
            <el-input
              v-model:value="activeData.append"
              placeholder="请输入后缀"
            />
          </el-form-item>
          <el-form-item
          ...
          >
            ...
            >
              <template v-slot:append>
                <el-select
                  v-model:value="activeData.sizeUnit"
                  :style="{ width: '66px' }"
                >
          ...
          >
            <el-input
              v-model:value="activeData.buttonText"
              placeholder="请输入按钮文字"
            />
          </el-form-item>
          <el-form-item
          ...
          <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
            ...
            <el-form-item label="数据类型">
              <el-radio-group v-model:value="activeData.dataType" size="small">
            ...
            <template v-if="activeData.dataType === 'dynamic'">
              <el-form-item label="标签键名">
                <el-input
                  v-model:value="activeData.labelKey"
                  placeholder="请输入标签键名"
                />
              </el-form-item>
              <el-form-item label="值键名">
                <el-input
                  v-model:value="activeData.valueKey"
                  placeholder="请输入值键名"
                />
              </el-form-item>
              <el-form-item label="子级键名">
                <el-input
                  v-model:value="activeData.childrenKey"
                  placeholder="请输入子级键名"
                />
              </el-form-item>
            </template>
          ...
          <el-form-item
            ...
            label="选项样式"
          >
            <el-radio-group v-model:value="activeData.optionType">
          ...
          <el-form-item
            ...
            label="是否带边框"
          >
            <el-switch v-model:value="activeData.border" />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item
            ...
            label="显示提示"
          >
            <el-switch v-model:value="activeData.showTip" />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item
            ...
            label="是否必填"
          >
            <el-switch v-model:value="activeData.required" />
          </el-form-item>
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          ...
          <el-form-item label="标签宽度">
            <el-input-number
              v-model:value="formConf.labelWidth"
              placeholder="标签宽度"
            />
          </el-form-item>
  ...
  methods: {
    ...
    onDefaultValueInput(str) {
      if (isArray(this.activeData.defaultValue)) {
        // 数组
        this.activeData['defaultValue'] = str
          .split(',')
